                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _buildIcon(context, Icons.phone, Colors.lightGreenAccent, 'Phone dialog'),
                          _buildIcon(context, Icons.favorite, Colors.red, 'Favorite dialog'),
                          _buildIcon(context, Icons.message, Colors.black, 'Message dialog'),
                        ],
                      ),
                      SizedBox(height: 20),
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10),
                            Text(
                              "Abdulbasit provides reliable car rental services, offering a range of vehicles to meet diverse customer needs. His focus is on ensuring convenience and satisfaction through well-maintained cars and flexible rental plans."
                              ,style: TextStyle(
                                fontSize: 16,
                                color: Colors.white,
                              ),
